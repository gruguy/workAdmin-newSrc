          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a
                  href="javascript:;"
                  @click="showConfirmDeleteItem(record.riceId)"
                  >删除</a
                >
              </a-menu-item>
            </a-menu>
...
const columns = [
  ...
  {
    title: "单位",
    dataIndex: "labourUnit",
    key: "labourUnit",
    type: "hide",
    scopedSlots: { customRender: "labourUnit" },
  },
  {
    title: "价格",
...
export default {
  ...
  methods: {
    ...
    showConfirmDeleteItem(id) {
      this.deleteItem(
        "/farmToolsPriceController/dels",
        "/farmToolsPriceController/getAdvancedQuery",
        id
      );
    },
    ...
    getDataList() {
      this.loading = true;
      this.$axios
        .get("/farmToolsPriceController/getAdvancedQuery", {
