          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a
                  href="javascript:;"
                  @click="showConfirmDeleteItem(record.recordId)"
                  >删除</a
                >
              </a-menu-item>
            </a-menu>
...
export default {
  ...
  methods: {
    ...
    showConfirmDeleteItem(id) {
      this.deleteItem(
        "/threeRiceSeedingController/dels",
        "/threeRiceSeedingController/getAdvancedQuery",
        id
      );
    },
    ...
    getDataList() {
      this.loading = true;
      this.$axios
        .get("/threeRiceSeedingController/getAdvancedQuery", {
