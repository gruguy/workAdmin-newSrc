<template>
  <div class="white-bg-wrapper">
    ...
    <div class="white-bg">
      ...
      >
        <span slot="learningDate" slot-scope="text">
          {{ text == "NULL" ? "--" : text }}
        </span>
...
const columns = [
  ...
  },
  {
    ...
    key: "learningTitle",
    scopedSlots: { customRender: "learningTitle" },
  },
  {
    title: "学习时间",
    ...
    key: "learningDate",
    width: "200px",
    scopedSlots: { customRender: "learningDate" },
  },
  {
    title: "操作",
    key: "action",
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      this.$axios
        .get("/learningRecordController/getAdvancedQuery", {
