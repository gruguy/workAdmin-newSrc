...
const columns = [
  ...
  },
  {
    ...
    dataIndex: "examId",
    key: "examId",
    scopedSlots: { customRender: "examId" },
  },
  {
    title: "考试分数",
...
export default {
  ...
  methods: {
    ...
    showConfirmDeleteItem(id) {
      this.deleteItem(
        "/examRecordController/dels",
        "/examRecordController/getAdvancedQuery",
        id
      );
    },
    ...
    getDataList() {
      this.loading = true;
      this.$axios
        .get("/examRecordController/getAdvancedQuery", {
