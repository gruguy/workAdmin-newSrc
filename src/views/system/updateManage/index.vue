    ...
    <div class="white-bg">
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a href="javascript:;" @click="showConfirmDeleteItem(record.upId)"
            >删除</a
          >
        </span>
      </a-table>
...
const columns = [
  {
    ...
    dataIndex: "upVersion",
    key: "upVersion",
    scopedSlots: { customRender: "upVersion" },
  },
  {
    title: "软件地址",
    dataIndex: "upUrl",
    key: "upUrl",
    type: "hide",
    scopedSlots: { customRender: "upUrl" },
  },
  {
    title: "更新特性",
    dataIndex: "upDesc",
    key: "upDesc",
    type: "hide",
    scopedSlots: { customRender: "upDesc" },
  },
  {
    title: "更新时间",
    dataIndex: "upTime",
...
export default {
  ...
  methods: {
    ...
    showConfirmDeleteItem(id) {
      this.deleteItem(
        "/upAppServerController/dels",
        "/upAppServerController/getAdvancedQuery",
        id
      );
    },
    handleOk(e) {
    ...
    getDataList() {
      this.loading = true;
      this.$axios
        .get("/upAppServerController/getAdvancedQuery", {
